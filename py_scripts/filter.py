...
@app.command()
def main(path: Annotated[Path, typer.Argument()], p_value_col, fold_change_col, output_dir):
    """
    ...
    filter_(files, p_value_col, fold_change_col, output_dir)
...
def filter_(files, p_value_col, fold_change_col, output_dir):
